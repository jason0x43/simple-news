...
pub(crate) fn set_host_command() -> Command {
...
pub(crate) async fn set_host(matches: &ArgMatches) -> Result<(), AppError> {
...
pub(crate) fn show_host_command() -> Command {
    Command::new("host-show").about("Show the current host")
}

pub(crate) async fn show_host() -> Result<(), AppError> {
